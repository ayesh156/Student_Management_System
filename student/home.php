						...
						<div class="tab-main">
							...
							<div class="tab-inner">
								<div id="tabs" class="tabs">
									<h2 class="inner-tittle">Welcome, <?php echo $_SESSION["s"]["first_name"] . " " . $_SESSION["s"]["last_name"]; ?></h2>
									<div class="graph">
										<nav>
											<ul>
											...
											<section class="sec1" id="section-1">
												<div class="mediabox">
													...
													<p> <strong>Email</strong>
														<?php echo $_SESSION["s"]["student_email"]; ?>
													</p>
													<p> <strong>Birthday:</strong>
														<?php echo $_SESSION["s"]["birthday"]; ?>
													</p>
													<p> <strong>Mobile:</strong>
														<?php echo $_SESSION["s"]["mobile"]; ?>
													</p>
													<p> <strong>Address:</strong>
														<?php echo $_SESSION["s"]["address"]; ?>
													</p>
													<p> <strong>Postal Code:</strong>
														<?php echo $_SESSION["s"]["postal_code"]; ?>
													</p>
													<?php

													$city_rs = Database::search("SELECT * FROM `city` WHERE `id`='" . $_SESSION["s"]["city_id"] . "'");
												...
												<div class="graph">
													...
													<table class="table table-bordered atable">
														...
														<tbody>
															...
															$tch_su_rs = Database::search("SELECT * FROM `teacher_details` INNER JOIN `teacher_has_subject` ON teacher_details.teacher_email = teacher_has_subject.teacher_email INNER JOIN `subject` ON teacher_has_subject.subject_id = `subject`.id");
															$tch_su_num = $tch_su_rs->num_rows;
															...
															?>
																...
																for ($x = 0; $x < $tch_su_num; $x++) {

																	$tch_su_data = $tch_su_rs->fetch_assoc();
																...
																?>
																	...
																	<tr>
																		...
																		<td><?php echo ($x + 1); ?></td>
																		<td><?php echo $tch_su_data["sub_name"]; ?></td>
																		<td><?php echo $tch_su_data["first_name"] . " " . $tch_su_data["last_name"]; ?></td>
																		<td>
																			<?php

																			$subj_rs = Database::search("SELECT * FROM `grade_has_subject` WHERE `grade_has_subject`.`subject_id`='" . $tch_su_data["subject_id"] . "'");
