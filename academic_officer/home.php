						...
						<div class="tab-main">
							...
							<div class="tab-inner">
								<div id="tabs" class="tabs">
									<h2 class="inner-tittle">Welcome, <?php echo $_SESSION["ao"]["first_name"] . " " . $_SESSION["ao"]["last_name"]; ?></h2>
									<div class="graph">
										<nav>
											<ul>
											...
											<section class="sec1" id="section-1">
												<div class="mediabox">
													...
													<p> <strong>Email</strong>
														<?php echo $_SESSION["ao"]["academic_officer_email"]; ?>
													</p>
													<p> <strong>Birthday:</strong>
														<?php echo $_SESSION["ao"]["birthday"]; ?>
													</p>
													<p> <strong>Mobile:</strong>
														<?php echo $_SESSION["ao"]["mobile"]; ?>
													</p>
													<p> <strong>Address:</strong>
														<?php echo $_SESSION["ao"]["address"]; ?>
													</p>
													<p> <strong>Postal Code:</strong>
														<?php echo $_SESSION["ao"]["postal_code"]; ?>
													</p>
													<?php

													$city_rs = Database::search("SELECT * FROM `city` WHERE `id`='" . $_SESSION["ao"]["city_id"] . "'");
