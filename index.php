...
<body>
		...
		<div class="agileits_w3layouts_banner_nav">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.html"><i class="fa fa-leanpub" aria-hidden="true"></i> Alpha Tech</a></h1>

				</div>
				<ul class="agile_forms">
					<li><a class="active" href="student/index.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Sign In now</a> </li>
				</ul>
	...
	<div class="about-bottom">
		<div class="col-md-12 w3l_about_bottom_left">
			<div class="video-grid-single-page-agileits">
				<div data-video="vXyHg7qkdVY" id="video"> <img src="images/banner2.jpg" alt="" class="img-responsive" /> </div>
			</div>
		...
		<div class="container">
			...
			<div class="services-w3ls-row">
				<div class="col-xs-4 services-grid agileits-w3layouts">
					...
					<p>We are recognised internationally for the high quality of our teaching, research and extensive industry partnerships, and Cisco Systems..</p>
				</div>
				<div class="col-xs-4 services-grid agileits-w3layouts">
					<h6>02</h6>
					<h5>Skilled Lecturers</h5>
					<p>Deciding what degree to study can be difficult, so we have created online sample lectures to give you an insight into some of the interesting topics around our subject areas.</p>
				...
				<div class="col-xs-4 services-grid agileits-w3layouts">
					...
					<p>We're making improvements to our Digital Library. Please bear with us while we make improvements to our Digital Library.</p>
				</div>
				<div class="clearfix"> </div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="team-w3l-grid">
				<div class="col-md-4 col-xs-4 about-poleft t1">
					<div class="about_img"><img src="images/tch1.png" alt="">
						<h5>Benedict</h5>
						<div class="about_opa">
							<p>Professor</p>
				...
				<div class="col-md-4 col-xs-4 about-poleft t2">
					<div class="about_img"><img src="images/tch2.png" alt="">
						<h5>Ruffalo</h5>
						<div class="about_opa">
				...
				<div class="col-md-4 col-xs-4 about-poleft t3">
					<div class="about_img"><img src="images/tch3.png" alt="">
						<h5>Larson</h5>
						<div class="about_opa">
							<p>Lecturers</p>
							<ul class="fb_icons2 text-center">
			...
			<div class="team-w3l-grid grid-2-team">
				<div class="col-md-4 col-xs-4 about-poleft t1">
					<div class="about_img"><img src="images/tch4.png" alt="">
						<h5>Hemsworth</h5>
						<div class="about_opa">
							<p>Professor</p>
							<ul class="fb_icons2 text-center">
				...
				<div class="col-md-4 col-xs-4 about-poleft t2">
					<div class="about_img"><img src="images/tch5.png" alt="">
						<h5>Jeremy</h5>
						<div class="about_opa">
							<p>Senior Lecturers</p>
							<ul class="fb_icons2 text-center">
				...
				<div class="col-md-4 col-xs-4 about-poleft t3">
					<div class="about_img"><img src="images/tch6.png" alt="">
						<h5>Chris</h5>
						<div class="about_opa">
							<p>Lecturers</p>
							<ul class="fb_icons2 text-center">
		...
		<div class="container">
			<div class="wthree_footer_grid_left">
				<div class="col-md-3 col-xs-3 wthree_footer_grid_left1">
					<h4>About Us</h4>
					<p>With over 29,000 students from around 100 countries, we’re a large and diverse university set in the heart of Birmingham with a focus on practice-based learning.</p>
				</div>
				<div class="col-md-3 col-xs-3 wthree_footer_grid_left1">
					<h4>Navigation</h4>
					<ul>
				...
				<div class="col-md-3 col-xs-3 wthree_footer_grid_left1 wthree_footer_grid_right1">
					<h4>Contact Us</h4>
					<ul>
						<li><i class="fa fa-envelope-o" aria-hidden="true"></i>alphaTech@gmail.com</li>
						<li><i class="fa fa-phone" aria-hidden="true"></i>0112 445557</li>
						<li><i class="fa fa-fax" aria-hidden="true"></i>+94 112 445557</li>
					</ul>
				</div>
				<div class="clearfix"> </div>
			</div>
	...
	<script type="text/javascript">
		...
		function init() {
			var mapOptions = {
				zoom: 11,
				center: new google.maps.LatLng(6.9270, 79.8640),
				styles: [{
					"featureType": "all",
			...
			var marker = new google.maps.Marker({
				position: new google.maps.LatLng(6.9270, 79.8640),
				map: map,
			});
		}
	</script>
