						...
						<div class="tab-main">
							...
							<div class="tab-inner">
								<div id="tabs" class="tabs">
									<h2 class="inner-tittle">Welcome, <?php echo $_SESSION["t"]["first_name"] . " " . $_SESSION["t"]["last_name"]; ?></h2>
									<div class="graph">
										<nav>
											<ul>
											...
											<section class="sec1" id="section-1">
												<div class="mediabox">
													...
													<p> <strong>Email</strong>
														<?php echo $_SESSION["t"]["teacher_email"]; ?>
													</p>
													<p> <strong>Birthday:</strong>
														<?php echo $_SESSION["t"]["birthday"]; ?>
													</p>
													<p> <strong>Mobile:</strong>
														<?php echo $_SESSION["t"]["mobile"]; ?>
													</p>
													<p> <strong>Address:</strong>
														<?php echo $_SESSION["t"]["address"]; ?>
													</p>
													<p> <strong>Postal Code:</strong>
														<?php echo $_SESSION["t"]["postal_code"]; ?>
													</p>
													<?php

													$city_rs = Database::search("SELECT * FROM `city` WHERE `id`='" . $_SESSION["t"]["city_id"] . "'");
