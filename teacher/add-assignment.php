...
?>
	...
	<head>
		<title>Add Assignments | Home</title>
						...
						<div class="forms-main">
							...
							<div class="graph-form">
								<div class="validation-form">
									<!---->
									<h2 style="text-align: center;">Add Assignments</h2>
									...
									<div class="col-md-12 form-group1 group-mail">
										<label class="control-label" for="ass_name">Assignment Name</label>
										<input type="text" placeholder="Assignment Name" name="ass_name" id="ass_name">
									</div>

									<div class="col-md-12 form-group1 form-last">
										<label class="control-label" for="ass_desc">Description</label>
										<textarea cols="50" rows="4" class="form-control1" id="ass_desc" placeholder="Description"></textarea>
									</div>

									<div class="col-md-12 mt-30">
										<input type="file" class="disNone" id="assFile" accept=".doc,.docx,.ppt,.pptx,application/msword, application/pdf, application/vnd.ms-powerpoint" />
										<label for="assFile" style="display: inline;" class="btn purple mt-5" onclick="uploadAssignment()">Upload Assignment</label>
										<h4 style="display: inline;" id="assFileName"></h4>
									</div>

									<div class="clearfix"> </div>
									<div class="col-md-12 form-group button-2">
										<input type="button" class="blue btn1" value="Add Assignment" onclick="addAssignment()">
										<input type="button" class="red btn1" value="Reset" onclick="window.location = 'add-assignment.php';">
									</div>
									<div class="clearfix"> </div>
