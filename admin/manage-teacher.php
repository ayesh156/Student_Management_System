...
?>
	...
	<head>
		<title>Manage Teachers | Home</title>
				...
				<div class="inner-content">
					...
					<div class="outter-wp">
						...
						<div class="graph-visual tables-main">
							<h2 class="inner-tittle">Manage Teachers</h2>
							...
							<div class="graph">
								...
								<div class="form-group">
									<div class="col-sm-5 search">
										<div class="row">
											<div class="col-sm-10">
												<input type="text" class="form-control" name="tch_search" id="tch_search" placeholder="Search...">
											</div>
											<div class="col-sm-2">
												<a class="btn2 blue" onclick="teacherSearch(0);">Search</a>
											</div>
										</div>
									</div>
								</div>

								<div class="tables" id="teacherView">
