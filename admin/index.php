	...
	<div class="error_page">
		...
		<div class="error-top">
			...
			<div class="login">
				...
				<input type="text" class="text" id="adInput" name="admin_username" placeholder="Username / Email" />
				<div class="submit"><input type="submit" value="Send Verification Code" name="admin_signin" id="subBtn" onclick="adminVerification();"></div>
				<div class="clearfix"></div>
			</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="text" class="text" id="advcode">
				</div>
