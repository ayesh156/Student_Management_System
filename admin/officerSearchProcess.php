...
if (!empty($_POST["t"])) {
    ...
    $query = "SELECT * FROM `academic_officer` INNER JOIN `academic_officer_details` ON academic_officer.email = academic_officer_details.academic_officer_email INNER JOIN `gender` ON academic_officer.gender_id = gender.id INNER JOIN `city` ON academic_officer_details.city_id = city.id WHERE `academic_officer`.`email` LIKE '%" . $t . "%' OR `academic_officer`.`user_name` LIKE '%" . $t . "%' OR `academic_officer_details`.`first_name` LIKE '%" . $t . "%' OR `academic_officer_details`.`last_name` LIKE '%" . $t . "%' ";
} else {
