...
?>
	...
	<head>
		<title>Manage Academic Officer | Home</title>
					...
					<div class="outter-wp">
						...
						<div class="sub-heard-part">
							<ol class="breadcrumb m-b-0">
								...
								<li class="active">Manage Academic Officers</li>
							</ol>
						</div>
						<!--//sub-heard-part-->
						<div class="graph-visual tables-main">
							<h2 class="inner-tittle">Manage Academic Officers</h2>
							...
							<div class="graph">
								...
								<div class="form-group">
									<div class="col-sm-5 search">
										<div class="row">
											<div class="col-sm-10">
												<input type="text" class="form-control" name="aof_search" id="aof_search" placeholder="Search...">
											</div>
											<div class="col-sm-2">
												<a class="btn2 blue" onclick="officerSearch(0);">Search</a>
											</div>
										</div>
									</div>
								</div>

								<div class="tables" id="officerView">
