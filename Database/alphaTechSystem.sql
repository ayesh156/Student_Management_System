...
-- Dumping data for table student_ms_db.academic_officer_image: ~0 rows (approximately)
...
-- Dumping data for table student_ms_db.admin: ~1 rows (approximately)
INSERT INTO `admin` (`email`, `user_name`, `verification_code`, `gender_id`) VALUES
	('sdachathuranga@gmail.com', 'Ayesh156', '63b937a039371', 1),
...
-- Dumping data for table student_ms_db.admin_details: ~1 rows (approximately)
...
-- Dumping data for table student_ms_db.as_display_status: ~1 rows (approximately)
...
-- Dumping data for table student_ms_db.city: ~4 rows (approximately)
...
-- Dumping data for table student_ms_db.lesson_note: ~2 rows (approximately)
...
-- Dumping data for table student_ms_db.province: ~8 rows (approximately)
...
INSERT INTO `student` (`email`, `user_name`, `password`, `verification_code`, `joined_date`, `gender_id`, `status_id`, `grade_id`, `option_id`, `payment_status_id`) VALUES
	...
	('eshara@gmail.com', 'Eshara157', 'eshara157', 'dfsdfhgase', '2023-01-03', 1, 2, 2, 2, 2),
	('sandeepa@gmail.com', 'sandeepa123', 'sandeepa123', 'fshgjhdffa', '2023-01-04', 1, 2, 3, 2, 2),
	('sdachathuranga@gmail.com', 'Ayesh156', 'ayesh156', 'dfadfsdfsdfd', '2022-12-01', 1, 1, 5, 2, 1),
...
-- Dumping data for table student_ms_db.student_grade_payment: ~3 rows (approximately)
...
-- Dumping data for table student_ms_db.student_image: ~3 rows (approximately)
...
-- Dumping data for table student_ms_db.subject: ~6 rows (approximately)
...
-- Dumping data for table student_ms_db.teacher_has_subject: ~3 rows (approximately)
...
INSERT INTO `teacher_image` (`path`, `teacher_email`) VALUES
	('../images/teacher_img/ Samali1_63b830cec7cdf.png', 'samali@gmail.com');
